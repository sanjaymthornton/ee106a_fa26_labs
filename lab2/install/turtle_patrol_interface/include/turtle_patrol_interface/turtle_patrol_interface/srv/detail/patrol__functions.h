...
#ifndef TURTLE_PATROL_INTERFACE__SRV__DETAIL__PATROL__FUNCTIONS_H_
#define TURTLE_PATROL_INTERFACE__SRV__DETAIL__PATROL__FUNCTIONS_H_
...
#include "turtle_patrol_interface/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_patrol_interface
bool
 ...
 * calls
 * turtle_patrol_interface__srv__Patrol_Request__init().
...
/**
 * It calls
 * turtle_patrol_interface__srv__Patrol_Request__fini()
 ...
 * turtle_patrol_interface__srv__Patrol_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * turtle_patrol_interface__srv__Patrol_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtle_patrol_interface__srv__Patrol_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_patrol_interface
...
/**
 * It calls
 * turtle_patrol_interface__srv__Patrol_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_patrol_interface
...
/**
 * It allocates the memory for the array and calls
 * turtle_patrol_interface__srv__Patrol_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_patrol_interface
...
/**
 * It calls
 * turtle_patrol_interface__srv__Patrol_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLE_PATROL_INTERFACE__SRV__DETAIL__PATROL__FUNCTIONS_H_
