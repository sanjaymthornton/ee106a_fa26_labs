...
static const _Patrol_Request_type_support_symbol_names_t _Patrol_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_patrol_interface, srv, Patrol_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_patrol_interface, srv, Patrol_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_patrol_interface, srv, Patrol_Request)() {
  return &::turtle_patrol_interface::srv::rosidl_typesupport_c::Patrol_Request_message_type_support_handle;
}
...
static const _Patrol_Response_type_support_symbol_names_t _Patrol_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_patrol_interface, srv, Patrol_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_patrol_interface, srv, Patrol_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_patrol_interface, srv, Patrol_Response)() {
  return &::turtle_patrol_interface::srv::rosidl_typesupport_c::Patrol_Response_message_type_support_handle;
}
...
static const _Patrol_type_support_symbol_names_t _Patrol_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_patrol_interface, srv, Patrol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_patrol_interface, srv, Patrol)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtle_patrol_interface, srv, Patrol)() {
  return &::turtle_patrol_interface::srv::rosidl_typesupport_c::Patrol_service_type_support_handle;
}
